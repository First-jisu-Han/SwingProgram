...
public class CourseRegisterView extends JFrame {
    ...
    Button registerButton = new Button("수강신청");
    ...
    CourseRegisterView(){
        ...
        scroll1.setBorder(BorderFactory.createEmptyBorder(10,10,10,10));	//너무 붙어있어서 가장자리 띄움(padding)
        ...
        scroll2.setBorder(BorderFactory.createEmptyBorder(10,10,10,10));	//너무 붙어있어서 가장자리 띄움(padding)
